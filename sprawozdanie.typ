...
#align(center)[
  #text(size: 2em)[Zastsowanie modelu LSTM do modelowania jezyka naturalnego]
...
Kod wykorzystany do przetwarzania danych, trenowania modelu oraz jego testowania jest dostępny
